...
<?php
    include  "menu.php" ;
?>
    <a href="cadconta.php">Nova Conta</a><br><br>
    ...
    <form method="POST">
        ...
        <br><br>
        <a href="alistarconta.php">Listar todos</a><br>
    ...
    ?>
            <tr>
                ...
                <td><a href='cadconta.php?acao=editar&conta_id=<?php echo $linha['conta_id']; ?>'><img class="icon" src="img/edit.png" alt=""></a></td>
                <td><a href="javascript:excluirRegistro('acaoconta.php?acao=excluir&conta_id=<?php echo $linha['conta_id']; ?>')"><img class="icon" src="img/delete.png" alt=""></a></td>
            </tr>
        <?php } ?>
        </table>
    <?php
