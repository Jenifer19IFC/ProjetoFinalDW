...
<?php
    include  "menu.php" ;
?>
    <a href="cadtipoReceita.php">Nova categoria</a><br><br>
    ...
    <form method="POST">
        ...
        <br><br>
        <a href="alistartipoReceita.php">Listar todos</a><br>
    ...
    try {
        ...
        if ($optionSearchUser != "") {
            if ($valorUser == "") {
                ...
                $sql = ("SELECT * FROM treceita ORDER BY $optionOrderUser;");
            } elseif ($optionSearchUser == "categoria") {
                $sql = ("SELECT * FROM treceita WHERE $optionSearchUser LIKE '$valorUser%' ;");
            } else {
                $sql = ("SELECT * FROM treceita WHERE $optionSearchUser LIKE '$valorUser%' ORDER BY $optionOrderUser;");
            }
        } else {
    ...
    ?>
            <tr>
                ...
                <td><a href='cadtipoReceita.php?acao=editar&id=<?php echo $linha['id']; ?>'><img class="icon" src="img/edit.png" alt=""></a></td>
                <td><a href="javascript:excluirRegistro('acaotipoReceita.php?acao=excluir&id=<?php echo $linha['id']; ?>')"><img class="icon" src="img/delete.png" alt=""></a></td>
            </tr>
        <?php } ?>
        </table>
    <?php
